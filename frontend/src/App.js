    ...
    <div className='app'>
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/mybooks' element={<ProtectedRoutes><MyBooks /></ProtectedRoutes>} />
          <Route path='/approvals' element={<ProtectedRoutes><PendingApprovals /></ProtectedRoutes>} />
          <Route path='/books-read' element={<ProtectedRoutes><BooksRead /></ProtectedRoutes>} />
          <Route path='/publishing' element={<ProtectedRoutes><Publishing /></ProtectedRoutes>} />
          <Route path='/editing-publishing' element={<ProtectedRoutes><EditingAndPublishing /></ProtectedRoutes>} />
          <Route path='/pending-payments' element={<ProtectedRoutes><PaymentDetails /></ProtectedRoutes>} />
